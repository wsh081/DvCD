...
__all__ = ['ShuffleV1_distill', 'ShuffleV1']
...
class ShuffleNetDistill(nn.Module):
    """专门用于知识蒸馏的ShuffleNet模型"""

    def __init__(self, cfg, num_classes=100):
        super(ShuffleNetDistill, self).__init__()
        self.shufflenet = ShuffleNet(cfg, num_classes)
...
def ShuffleV1_distill(**kwargs):
    cfg = {
        'out_planes': [240, 480, 960],
        'num_blocks': [4, 8, 4],
        'groups': 3
    }
    return ShuffleNetDistill(cfg, **kwargs)
